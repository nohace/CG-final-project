...
def generate_points(points, canvas, footer_label, main_x, main_y, num_points=20, graph_range=1000, clustered=False):
    ...
    if clustered:
        # Randomize number of clusters between 1 and 7
        ...
        # Ensure no stray points by only generating clustered points
...
def create_gui():
    ...
    brute_force_button.grid(row=0, column=10, padx=5, pady=5)
